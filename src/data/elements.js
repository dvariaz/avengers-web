...
const elements = {
    'general': {
        ...
        history: 'Después de haber adquirido la Gema del Poder que había quedado bajo custodia de los Nova Corps en el planeta Xandar, el malvado titán intergaláctico Thanos, intercepta la nave espacial que transportaba a los sobrevivientes de la destrucción de Asgard y la ataca.'
    },
    'guantelete': {
    ...
    'espacio': {
        ...
        history: 'Como corresponde a su nombre, la Gema del Espacio adquirió el dominio sobre la estructura del espacio y el poder de teletransportar a sus usuarios a cualquier parte del universo.'
    },
    'realidad': {
    ...
    'mente': {
        ...
        history: 'Fue anteriormente empleada por Loki en el interior del Cetro, quien lo recibió como un obsequio de Thanos durante la Invasión Chitauri. Después de la Batalla de Nueva York, el Cetro fue confiscado por S.H.I.E.L.D., pero más tarde robada por von Strucker, quien le ordenó a sus científicos que la usaran para darle poderes extraordinarios a los gemelos Wanda y Pietro Maximoff. El cetro fue ocultado por SHIELD hasta que fue robado por el Baron Strucker. La Gema acabo siendo utilizada por los Vengadores para crear al androide Vision, que utilizaba su energía para conformar su personalidad.'
    },
    'tiempo': {
        name: ['tiempo','bbffbb'],
        ...
        history: 'Ha sido utilizada por la humanidad para proteger la Tierra del demonio Dormammu. Encontrada por el hechicero Agamotto, la escondió en un dispositivo llamado el Ojo de Agamotto, que fue estudiado por Doctor Strange, que la utilizó para combatir a Kaecilius y encerrar a Dormammu en un bucle temporal infinito.'
    },
    'alma': {
        name: ['alma','ffbb'],
