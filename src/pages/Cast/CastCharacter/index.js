...
//TODO: Mirar como animar al desmontar con react pose y react router, el problema es que la otra pagina se pone encima.

const CastCharacter = ({ name, background, photo, position }) => {
    ...
    return (
        <div className={ `CharacterData ${ titleize(position)}` }>
