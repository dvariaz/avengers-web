...
const StyledGraphicIndicator = styled.svg`
    position: absolute;
    margin: auto;
    z-index: 30;
    top: 0;
...
//TODO: Hay que establecer la localizacion del objeto debajo de la linea izquierda

const GraphicIndicator = ({ color, location }) => {
    return (
        <>
            <StyledGraphicIndicator id="ElementIndicator" viewBox="0 0 512 512">
                <defs>
                ...
                <g id="Line_Left">
                    <line stroke={ color } strokeWidth="5" x1="167.4" y1="313.6" x2="428" y2="53"/>
                </g>
                <g id="Line_Right">
                    <line stroke={ color } strokeWidth="5" x1="84" y1="459" x2="344.6" y2="198.4"/>
                </g>
